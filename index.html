			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="elements.html">Doesn't Steal Your Coins</a></li>
					</ul>
				</nav>
			</header>
				...
				<div class="container">
					...
					<div class="row 200%">
						...
						<section class="4u 12u$(small)">
							...
							<p>Go ahead and grab my script from <a href="https://openuserjs.org/scripts/Suave/csgodouble.com_-_automated_cleaned_by_Suave/source">openuserjs</a></p>
						</section>
						<section class="4u$ 12u$(small)">
				...
				<div class="container">
					<div class="row">
						...
						<section class="4u$ 12u$(medium) 12u$(small)">
							<h3>Contact Us</h3>
							<ul class="icons">
								<li><a href="https://steamcommunity.com/id/TjIipinski/" class="icon rounded fa-steam"><span class="label">Twitter</span></a></li>
							</ul>
						</section>
					</div>
					<ul class="copyright">
